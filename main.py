...
key_path = r'SystemFileAssociations\\.txt\\shell\\Organiser\\' # Change 'Organiser' to the name of your project

# Create outer key
key = reg.CreateKey(reg.HKEY_CLASSES_ROOT, key_path)
reg.SetValue(key, '', reg.REG_SZ, '&Organiser')  # Change 'Organise folder' to the function of your script

# create inner key
key1 = reg.CreateKey(key, r"command")
reg.SetValue(key1, '', reg.REG_SZ, python_exe + f' "{cwd}\\Organiser.py"') # change 'file_organiser.py' to the name of your script
...
# C:\Users\Antek\PycharmProjects\pythonProject\venv\Scripts\python.exe "C:\Users\Antek\PycharmProjects\pythonProject\int.py"
